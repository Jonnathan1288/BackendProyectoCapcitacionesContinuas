...
@Service
public class PrerequisitoServiceImpl extends GenericServiceImplv2<PrerequisitoCurso, Integer> implements PrerequisitoCursoService {

    @Autowired
    private PrerequisitoCursoRepository prerequisitoCursoRepository;

    @Override
    public GenericRepository<PrerequisitoCurso, Integer> getDao() {
